...
?>
        ...
        ?>
            <li class="page-item <?= implode(' ', $classes) ?>"><a class="page-link" href="<?= ($href) ?>"><?= ($previous) ?></a></li>
        <?php
                /**
        ...
        ?>
            <li class="page-item number"><a class="page-link" data-pagenumber="<?= ($current + $x - $leading) ?>" href="<?= ($href) ?>"><?= ($current + $x - $leading) ?></a></li>
        <?php
                    }

                    // print current page
        ?>
            <li class="page-item number active"><a class="page-link" data-pagenumber="<?= ($current) ?>" href="#"><?= ($current) ?></a></li>
        <?php
        ...
        ?>
            <li class="page-item number"><a class="page-link" data-pagenumber="<?= ($current + $x + 1) ?>" href="<?= ($href) ?>"><?= ($current + $x + 1) ?></a></li>
        <?php
                    }
                }
        ...
        ?>
            <li class="page-item <?= implode(' ', $classes) ?>"><a class="page-link" href="<?= ($href) ?>"><?= ($next) ?></a></li>
        </ul>

    <div class="total-rows">
        <span>Отображено <?php echo ($current - 1) * $rpp ?> - <?php echo $current * $rpp?> из <?php echo $total_rows?></span>
    </div>
        </nav>
<?php
    }
